...
import { Get, Type, Post, Put, Delete, SerializeOptions } from '@nestjs/common';
...
export const Crud =
    ...
    <T extends BaseController<any> >(Target: Type<T>) => {
        ...
        const { id, enabled, dto } = Reflect.getMetadata(CRUD_OPTIONS, Target) as CurdOptions;
